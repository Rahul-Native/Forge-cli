...
// State to keep track of added fragments and their values
    ...
    async function pushFileToGitHub(icePackRequestForm, baseURL, buildName, token, icePackJsonName, sha, action, repository) {
        ...
        let requestBodyString = {"message":`${action} from forge`,"committer":{"name":"rahul","email":"octocat@github.com"},"content":requestBody, "sha":`${sha}`}
    ...
    async function handleGithub(icePackRequestForm, moduleName, buildName, icePackJsonName) {
        ...
        let token;
        let baseURL;
        token = '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'
        ...
        // repos.forEach(async (repo)=>{
            ...
            // await handleRepo(icePackRequestForm, 'https://api.github.com/repos/RahulNative/', 'main', icePackJsonName, token, 'nativescript-vue');
        // })
